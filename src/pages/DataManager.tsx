  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const recordId = await saveDataRecord({
        ...
        content,
        recordType,
        metadata: { created_from: 'data_manager' },
      });
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-lg text-gray-600">
              Store and verify your data with blockchain integrity
            </p>
          </div>
          ...
          {records.length === 0 ? (
            <Card className="text-center py-12">
              <CardContent>
                ...
                <p className="text-gray-500 mb-4">Start by creating your first data record</p>
